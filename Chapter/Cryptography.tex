...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{Figure/cryp1.png} 
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{Figure/cryp2.png} 
\end{figure}
\noindent Here, we can see the result is "wachtwoord" repeating itself.
