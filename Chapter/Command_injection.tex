...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{Figure/com_res_low.png} 
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{Figure/command_med2.png} 
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{Figure/com_res_med.png} 
\end{figure}

\noindent \textbf{Patching:}
\noindent To prevent command injection at the medium security level, the same patching approach used in the previous level is applied, as there are no significant changes in the overall program logic.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{Figure/com_res_high.png} 
\end{figure}

\noindent \textbf{Patching:}

\noindent For the high security level, the previously applied patching strategy is retained, since the application only introduces change in the blacklist instead of the program logic. As such, strict input validation and proper argument escaping remain effective in mitigating command injection vulnerabilities.