...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{Figure/sqlib1.png}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{Figure/sqlib_length.png}
\end{figure}
...
\noindent \textbf{Patching:} For blind SQL injection, we apply the same patching method as SQL injection: stop concatenating user input into SQL queries and use prepared statements.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{Figure/sqlib_med1.png} 
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{Figure/sqlib_med2.png} 
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{Figure/sqlib_high1.png} 
\end{figure}
